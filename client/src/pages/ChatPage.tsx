...
const ChatPage: React.FC = () => {
  return (
    ...
    <div className="flex h-full w-full overflow-hidden"> {/* Ensure full height and width, overflow hidden for children to manage scroll */}
      ...
      <div className="w-72 md:w-1/3 lg:w-1/4 h-full hidden md:flex flex-col border-r border-dark-border"> {/* Width matches sidebar, hidden on mobile for Zingle layout */}
         <ContactList />
      </div>
